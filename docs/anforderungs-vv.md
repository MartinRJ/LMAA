...
| TST-001 | Tests dürfen tägliche BYOK-/Historiedaten nicht zerstören | **validiert**; persönliche App-Daten sind produktive Stakeholderdaten | **erfüllt**; Default-Testvariante `instrumented` nutzt `de.lmaa.app.testbed`. Zwölf Instrumentierungstests liefen isoliert auf dem Zieltablet; danach wurden ausschließlich die Testbed-Pakete entfernt. Der Live-BYOK-Test ist standardmäßig durch eine explizite Annahme gesperrt | Isolation in CI und bei künftigen Gerätetests beibehalten |
